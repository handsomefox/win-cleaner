...
pub(crate) const SORT_LARGEST: &str = "\u{E446}"; // SORT_DESCENDING
pub(crate) const SORT_SMALLEST: &str = "\u{E444}"; // SORT_ASCENDING
pub(crate) const CLEAR: &str = "\u{E4F6}"; // X
pub(crate) const EXPAND: &str = "\u{E13A}"; // CARET_RIGHT
pub(crate) const COLLAPSE: &str = "\u{E136}"; // CARET_DOWN
pub(crate) const EXPAND_ALL: &str = "\u{E536}"; // ARROWS_OUT_LINE_VERTICAL
pub(crate) const COLLAPSE_ALL: &str = "\u{E532}"; // ARROWS_IN_LINE_VERTICAL
